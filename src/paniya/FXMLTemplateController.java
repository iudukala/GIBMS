...
public class FXMLTemplateController implements Initializable {
   ...
   private void initializeglButtons() {
    ...
    private void initializebvr_search() {
        Commons.subAnchorButton cb = new Commons.subAnchorButton(bvr_anchorpane, "SEARCH", Commons.SEARCH_GLYPH);
         ...
         Commons.subAnchorButton hi = new Commons.subAnchorButton(bvr_anchorpane, "HISTORY", Commons.HAMBURGER_GLYPH);
         hi.setCoordinates(400, 90);
