...
public class history
{
    ...
    static void getPopOvergl(dbConcurrent nbconn, String atransaction_code, JFXTextField gl_search, JFXButton searchhistoryButton) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    
    public static void getPopOver1(dbConcurrent nbconn, JFXTextField textfield, JFXButton button)
    {
        Label heading = new Label("Find Branch Name");
        heading.getStyleClass().add("subheaders");
        heading.setStyle("-fx-padding: 10 5 10 20;");
        ...
        JFXTextField serial = new JFXTextField();
        serial.setPromptText("branch_id");
        serial.setStyle(textStyle);
        serial.setPrefWidth(textWidth);
        ...
        btn_search.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            {
                Entity search_ent = new Entity(query,nbconn);
                search_ent.add("branch_id", serial.getText());
                tvh_pnj.writeToTable(search_ent.executeAsSearch());
            }
        });
        ...
        table_pop.getSelectionModel().selectedItemProperty().addListener(new ChangeListener()
        {
            ...
            {
                if(tvh_pnj.getSelection()!=null)
                    textfield.setText(tvh_pnj.getSelection().getAsString("location"));
            }
        });
    ...
    public static void getPopOver2(dbConcurrent nbconn, JFXTextField textfield, JFXButton button)
    {
        Label heading = new Label("Find Company name");
        heading.getStyleClass().add("subheaders");
        heading.setStyle("-fx-padding: 10 5 10 20;");
        ...
        JFXTextField serial = new JFXTextField();
        serial.setPromptText("company_id");
        serial.setStyle(textStyle);
        serial.setPrefWidth(textWidth);
        ...
        btn_search.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            {
                Entity search_ent = new Entity(query,nbconn);
                search_ent.add("company_id", serial.getText());
                tvh_pnj.writeToTable(search_ent.executeAsSearch());
            }
        });
        ...
        table_pop.getSelectionModel().selectedItemProperty().addListener(new ChangeListener()
        {
            ...
            {
                if(tvh_pnj.getSelection()!=null)
                    textfield.setText(tvh_pnj.getSelection().getAsString("company_name"));
            }
        });
    ...
    public static void getPopOver3(dbConcurrent nbconn, JFXTextField textfield, JFXButton button)
    {
        Label heading = new Label("Find Transaction Name");
        heading.getStyleClass().add("subheaders");
        heading.setStyle("-fx-padding: 10 5 10 20;");
        ...
        JFXTextField serial = new JFXTextField();
        serial.setPromptText("transaction_code");
        serial.setStyle(textStyle);
        serial.setPrefWidth(textWidth);
        ...
        String query = "select * from transaction_code ";
        tableViewHandler tvh_pnj = new tableViewHandler(table_pop, query, nbconn);
        tvh_pnj.writeToTable();
        ...
        btn_search.setOnAction(new EventHandler<ActionEvent>()
        {
            ...
            {
                Entity search_ent = new Entity(query,nbconn);
                search_ent.add("transaction_code", serial.getText());
                tvh_pnj.writeToTable(search_ent.executeAsSearch());
            }
        });
        ...
        table_pop.getSelectionModel().selectedItemProperty().addListener(new ChangeListener()
        {
            ...
            {
                if(tvh_pnj.getSelection()!=null)
                    textfield.setText(tvh_pnj.getSelection().getAsString("transaction_name"));
            }
        });
