...
public class Commons
{
    public static class subAnchorButton
    {
        ...
        public JFXButton generateButton()
        {
            ...
            if(button_depth == null)button_depth=0;
            if(glyph_height == null) glyph_height = 20;
        ...
        public void setButtonSize(int length, int heigth){button_length = length; button_height = heigth;}
        public void setButtonTooltip(String tooltip){this.tooltip = tooltip;}
        
        public void setGlyphWidth(int width){glyph_width = width;}
        public void setGlyphSize(int height, int width){glyph_width = height; glyph_height = width;}
