...
public class CustomerOldController implements Initializable
{
    ...
    @FXML private TextField text_pphone;
    @FXML private TextField text_homeaddr;
    @FXML private TextField text_email;
    
    //tab1 customer controls
    @FXML private TextField text_wphone;
    @FXML private ToggleGroup sectorGroup;
    @FXML private TextField text_company;
    @FXML private DatePicker date_employment;
    @FXML private TextField text_position;
    
    @FXML private TextField text_account;
    @FXML private TextField text_branch;
    @FXML private TextField text_bank;
    
    @FXML private TextField text_earncareer;
    @FXML private TextField text_earnbusiness;
    @FXML private TextField text_earnhouses;
    ...
    private Entity getPersonInputs()
    {
        ...
        if(!Validator.isPhone(personal_phone)) return null;
    ...
    @FXML private TableView table_search;
    @FXML private TextField text_searchnic;
    ...
    @FXML private RadioButton radio_married;
    @FXML private RadioButton radio_unmarried;
    @FXML private RadioButton radio_permanent;
    @FXML private RadioButton radio_temporary;
    
    @FXML private Tab tab_addcustomer;
    @FXML private Button button_add;
    @FXML private Button button_custupdate;
    @FXML private TabPane tabpane_customer;
    
    
    @FXML private Text textelement_nic;
...
//        }
    ...
    @FXML private Button button_searchdelete;
    @FXML private Button button_searchupdate;
    /**
